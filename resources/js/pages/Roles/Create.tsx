            ...
            <div className="max-w-3xl mx-auto p-6 space-y-6">
                ...
                <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl border border-border shadow-sm space-y-6">
                    ...
                    <div className="flex justify-end gap-3 pt-6 border-t">
                        ...
                        <button type="submit" disabled={processing} className="px-6 py-2.5 bg-secondary text-white font-bold rounded-lg hover:bg-secondary/90 disabled:opacity-50">{processing ? 'Enregistrement...' : 'Enregistrer le rôle'}</button>
                    </div>
                </form>
            </div>
        </SettingsLayout>
